...
enum SidebarNavItem: string
{
    ...
    public static function fromRouteName(?string $routeName, ?string $category = null): ?self
    {
        ...
        return match (true) {
            ...
            $routeName === 'leave-approvals.cuti' => self::LeaveCutiApproval,
            $routeName === 'leave-approvals.izin' => self::LeaveIzinApproval,
            $routeName === 'leave-approvals.lembur' => self::LeaveLemburApproval,
    ...
    public function settingsRoutePath(): ?string
    {
        ...
        return match ($this) {
            ...
            self::LeaveCutiApproval => route('leave-approvals.cuti', ['status' => 'pending'], false),
            self::LeaveIzinApproval => route('leave-approvals.izin', ['status' => 'pending'], false),
            self::LeaveLemburApproval => route('leave-approvals.lembur', ['status' => 'pending'], false),
