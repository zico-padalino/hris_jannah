<div class="user-account-menu" data-user-account-menu>
    ...
    <div class="user-account-menu__panel" data-user-account-menu-panel role="menu" hidden>
        <div class="user-account-menu__header">
            @if(auth()->user()->hasProfilePhoto())
                <img src="{{ auth()->user()->profilePhotoUrl() }}" alt="" class="user-account-menu__header-avatar">
            @else
                <span class="user-account-menu__header-avatar user-account-menu__avatar--placeholder" aria-hidden="true">
                    {{ auth()->user()->profileInitials() }}
                </span>
            @endif
            <div class="min-w-0">
        ...
        <div class="user-account-menu__prefs">
            @include('partials.user-preferences')
        </div>

        <div class="user-account-menu__actions">
