...
<div class="panel-table table-mobile-scroll"><table class="table-readable min-w-full"><thead class="bg-slate-50"><tr><th class="px-4 py-3 text-left">Cabang</th><th class="px-4 py-3 text-left">Total</th><th class="px-4 py-3 text-left">Valid</th><th class="px-4 py-3 text-left">Invalid</th></tr></thead><tbody>
